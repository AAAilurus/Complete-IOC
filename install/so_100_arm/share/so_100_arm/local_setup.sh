...
: ${AMENT_CURRENT_PREFIX:="/root/so100_ws/install/so_100_arm"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/so_100_arm/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/so_100_arm/environment/path.sh"
